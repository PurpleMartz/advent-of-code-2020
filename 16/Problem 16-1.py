# -*- coding: utf-8 -*-
"""
Created on Sat Jan  9 21:13:59 2021
...
rules = list(map(lambda x: x.split(': ')[1], rules.split('\n')))
rulesRange = [getRanges(rule) for rule in rules]
rulesRange = set().union(*rulesRange)
